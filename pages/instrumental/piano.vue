            ...
            <li>
              <dl>
                ...
                <dd>
                  ...
                  <h5>师资优势</h5>
                  <p>{{ info.course_introduce.teachers }}</p>
                </dd>
              </dl>
            </li>
          </ul>
...
export default {
	...
	asyncData({ query }) {
		...
		return {
			...
			info: {
				title: title,
				be_propitious_to: '少儿|成人、零基础及有基础音乐爱好者、兴趣培养、才艺提升。',
				course_style: ['在线视频一对一'],
				course_introduce: {
					explain:
					...
					teachers: '美国辛辛那提大学 钢琴演奏 作曲 教学法博士及柴可夫斯基音乐学院硕士。',
				},
			},
		};
	},
	...
	& .course_detail {
		...
		& .content {
			...
			& .introduce {
				...
				& ul {
					background: url('~/assets/images/instrumental/piano/person.png') no-repeat;
					background-size: 60%;
